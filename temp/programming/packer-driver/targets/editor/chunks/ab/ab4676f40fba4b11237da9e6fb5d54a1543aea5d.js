System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, SpriteFrame, Sprite, director, Vec2, instantiate, Prefab, Enum, ItemType, Events, Item, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, FieldWatcher;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Events = _unresolved_3.default;
    }, function (_unresolved_4) {
      Item = _unresolved_4.Item;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("FieldWatcher", FieldWatcher = (_dec = ccclass('FieldWatcher'), _dec2 = property(SpriteFrame), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property({
        type: Enum(_crd && ItemType === void 0 ? (_reportPossibleCrUseOfItemType({
          error: Error()
        }), ItemType) : ItemType)
      }), _dec(_class = (_class2 = class FieldWatcher extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=ab4676f40fba4b11237da9e6fb5d54a1543aea5d.js.map