System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, director, Animation, Input, ItemType, InputType, Events, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Item;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'EventTouch', 'Vec3', 'director', 'Animation', 'Input']);
      ...
      _export("Item", Item = (_dec = ccclass('Item'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class Item extends Component {
        ...
        handleSubscription(activated) {
          ...
          this.InputC[func](Input.EventType.TOUCH_START, this.onDown, this);
...
//# sourceMappingURL=37b460edab7090f1d32e173dd9323d66cef51a6c.js.map